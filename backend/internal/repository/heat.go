...
type HeatRepository interface {
	...
	ListByStatuses(context.Context, []string, int) ([]model.Heat, error)
...
func (r *heatRepository) ListByStatuses(ctx context.Context, statuses []string, limit int) ([]model.Heat, error) {
